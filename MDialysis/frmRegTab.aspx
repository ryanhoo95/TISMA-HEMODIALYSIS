<%@ Page Title="" Language="C#" MasterPageFile="~/boardMain.master" AutoEventWireup="true" CodeFile="frmRegTab.aspx.cs" Inherits="MDialysis_frmAjax" %>
        ...
        <div class = "col-lg-12 col-xs-12">
                    ...
                    <div class = "container">
                        ...
                        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
                          <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="frmNewReg.aspx">New Registration<span class="sr-only">(current)</span></a></li>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <select class="form-control select2" style="width: 100%;">
                                        <option selected>Queue No</option>
                                        <option>Matric No</option>
                                        <option>IC No / Acid No</option>
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                      <li class="active"><a href="#patient-info" data-toggle="tab">Patient Information</a></li>
                      <li><a href="#med-his" data-toggle="tab">Medical History</a></li>
                      <li><a href="#hemo-data" data-toggle="tab">Hemodialysis Data</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="hemo-data">
                            <div class="box box-default">
                                <div class = "box-body">
                                    <div class="table-responsive">
                                        ...
                                        <table class="table no-margin">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    :</td>
                                                <td>
                                                    <asp:TextBox ID="txtHospital"  placeholder="Enter hospital" runat="server"></asp:TextBox>
                                                </td>
                                                <td>
