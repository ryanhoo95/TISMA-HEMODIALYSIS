<%@ Page Title="" Language="C#" MasterPageFile="~/boardMain.master" AutoEventWireup="true" CodeFile="frmNewReg.aspx.cs" Inherits="MDialysis_frmNewReg" %>
        ...
        <div class = "col-lg-12 col-xs-12">
                ...
                <div class = "box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">A. Patient Information</h3>
                    </div>
                    <!-- ./box-header -->
                    <div class = "box-body">
                    ...
                    <form>
                    <div class="box-header with-border">
                        <h3 class="box-title">B. Medical History</h3>
                    </div>
                    <!-- ./box-header -->
                    <div class = "box-body">
                        <div class="table-responsive">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">C. Hemodialysis Data</h3>
                    </div>
                    <!-- ./box-header -->
                    <div class = "box-body">
                        <div class="table-responsive">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title">D. Prescription</h3>
                    </div>
                    <!-- ./box-header -->
                    <div class = "box-body">
                        <div class="table-responsive">
